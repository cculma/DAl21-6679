...
- ldsep element is a matrix $m \times m$ with $R^2$ values. We are only interested in compare the $R^2$ among chomosomes (linkage groups). Thos correspond to lines 72 to 120 of `LD_plot.R`.
